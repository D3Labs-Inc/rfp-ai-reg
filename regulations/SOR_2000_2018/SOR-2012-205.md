...
| Entities    | ['Emulsifying, Gelling, Stabilizing', 'Gelling, Stabilizing', 'Health', 'Canada', 'Part B', 'Growth and Long-term Prosperity Act', 'Same', 'Food'] |
...
| if          | Food When an emuls if ying, gelling, stabilizing or thickening agent that is                                |
| if          | Food When an emuls if ying, gelling, stabilizing or thickening agent that is                                |
| when        | is set out in that column is met. when                                                                      |
| if          | practice” appear in column 3, the exemption applies if the amount of the agent that is added                |
| if          | practice” appear in column 3, the exemption applies if the amount of the agent that is added                |
| if          | Food additives An emuls if ying, gelling, stabilizing or thickening agent that is                           |
...
| Entities                            | Context                                                                                                                      |
|:------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------|
| Emulsifying, Gelling, Stabilizing   | for Food Additives That May Be Used as Emulsifying, Gelling, Stabilizing  or Thickening Agents.                              |
| Health                              | The Minister of  Health , pursuant to subsections 30.3(1) a and 30.5(1)                                                      |
| Emulsifying, Gelling, Stabilizing   | for Food Additives That May Be Used as Emulsifying, Gelling, Stabilizing  or Thickening Agents .                             |
| Gelling, Stabilizing                | Liste List means the List of Permitted Emulsifying, Gelling, Stabilizing or Thickening Agents published by the Department of |
| Health                              | or Thickening Agents published by the Department of Health on its website, as amended from time to                           |
...
| Food                                | Food When an emulsifying, gelling, stabilizing or thickening agent                                                           |
| Part B                              | food for which a standard is prescribed in Part B of the Food and Drug Regulations from the                                  |
| Food                                | Food additives An emulsifying, gelling, stabilizing or thickening agent                                                      |
...
| Date       | Context                                                                                                                                   |
|:-----------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2018-03-01 | FOOD AND DRUGS ACT Marketing Authorization for Food Additives That May Be Used as Emulsifying, Gelling, Stabilizing or Thickening Agents. |
