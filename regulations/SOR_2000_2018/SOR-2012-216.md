...
# URL
http://laws-lois.justice.gc.ca/eng/regulations/SOR-2012-216/FullText.html


# Summary
FOOD AND DRUGS ACT Marketing Authorization for Food Additives That May Be Used as Carrier or Extraction Solvents.
The Minister of Health, pursuant to subsections 30.3(1) a  and 30.5(1) a  of the  Food and Drugs Act b , issues the annexed  Marketing Authorization for Food Additives That May Be Used as Carrier or Extraction Solvents .
Food When a carrier or extraction solvent that is set out in column 1 of the List is added to a food that is set out in column 2, the food is exempt from the application of paragraphs 4(1)(a) and (d) and sections 6 and 6.1 of the  Food and Drugs Act  and sections B.01.042, B.01.043 and B.16.007, as applicable, of the  Food and Drug Regulations , in respect of the use or presence of the solvent only, if the amount of the solvent does not exceed the maximum residue or maximum level of use for that food that is set out in column 3 or 4, respectively, and if any other condition that is set out in column 4 is met.
Food additives A carrier or extraction solvent that is set out in column 1 of the List is exempt from the application of section B.16.100 of the  Food and Drug Regulations  if, at the time of sale, all of the other requirements in those Regulations that apply in respect of the solvent are met.


# Tags
['food', 'act', 'extract', 'comes', 'authorization', 'solvent']
...
| Constraints   | Context                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------|
| exceed        | if the amount of the solvent does not exceed the maximum residue or maximum level of use                   |
| maximum       | amount of the solvent does not exceed the maximum  residue or                                              |
| maximum       | amount of the solvent does not exceed the maximum  residue or                                              |
...
| when        | is set out in column 4 is met. when                                                                         |
| if          | the use or presence of the solvent only, if the amount of the solvent does not exceed                       |
| if          | the use or presence of the solvent only, if the amount of the solvent does not exceed                       |
| when        | is set out in that column is met. when                                                                      |
| if          | practice” appear in column 4, the exemption applies if the amount of the solvent that is added              |
| if          | practice” appear in column 4, the exemption applies if the amount of the solvent that is added              |
...
| Health                              | or Extraction Solvents published by the Department of Health on its website, as amended from time to              |
...
| Food                                | Food When a carrier or extraction solvent that is                                                                 |
| Part B                              | requirement that is set out in the standard. Part B                                                               |
| Food                                | Food additives A carrier or extraction solvent that is                                                            |
...
| Date       | Context                                                                                                           |
|:-----------|:------------------------------------------------------------------------------------------------------------------|
| 2018-03-01 | FOOD AND DRUGS ACT Marketing Authorization for Food Additives That May Be Used as Carrier or Extraction Solvents. |
