...
# URL
http://laws-lois.justice.gc.ca/eng/regulations/C.R.C.,_c._767/FullText.html


# Summary
FINANCIAL ADMINISTRATION ACT Order Respecting the Remission of Customs Duty and Taxes on Certain Goods Transhipped at Foreign Ports.
Short Title.
...
| Entities  | ['Subject', 'Remission', 'Amount', 'Canadabut', 'British Preferential'] |
...
| Condition   | Context                                                                                                     |
|:------------|:------------------------------------------------------------------------------------------------------------|
| when        | enjoying the privileges of the British Preferential Tariff when those goods are not, as required by section |
| unless      | The remission is not payable  unless satisfactory evidence is supplied to the Department of                 |
...
| British Preferential | originating in countries enjoying the privileges of the British Preferential Tariff when those goods are not, as required |
| Canadabut            | the importer, are transhipped from a foreign port. Canadabut                                                              |
| Amount               | Amount  of Remission.                                                                                                     |
| Remission            | Amount of  Remission .                                                                                                    |
| British Preferential | the duty and taxes properly payable under the British Preferential Tariff and those payable under the tariff that         |
