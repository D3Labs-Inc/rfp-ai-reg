...
| at least      | be able to withstand the ultimate loads for at least  three seconds without failure.                                                 |
...
| if          | a test of a representative part is acceptable, if the part tested is large enough to include              |
