# Title
 ...
 Housing and Urban Development. PART 87—NEW RESTRICTIONS ON LOBBYING


# ID

 CFR-2018-title24-vol1.Pt. 87
...
| Type        | Values                                                                                                                                                                                        |
|:------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Money       | [(192459.0, 'USD'), (19246.0, 'USD'), (150000.0, 'USD'), (100000.0, 'USD'), (25000.0, 'USD')]                                                                                                 |
| Constraints | ['greater', 'maximum', 'more than', 'no later than', 'before', 'after', 'prior to', 'less than', 'at least', 'within']                                                                        |
| Duration    | ['6 month', '30.0 day', '1 year']                                                                                                                                                             |
| Condition   | ['subject to', 'until', 'as soon as', 'where', 'not subject to', 'when', 'unless', 'if']                                                                                                      |
| Entities    | ['Budget', 'United States', 'U.S.C', 'Housing', 'Such', 'Puerto Rico', 'Agency', 'Local', 'Penalty', 'Columbia', 'Alaskan', 'Enforcement', 'Defense', 'Indian', 'U.S. Code', 'Certification'] |
...
| (150000.0, 'USD') | (2) A Federal loan or a commitment providing for the United States to insure or guarantee a loan exceeding $150,000 or the single family maximum mortgage limit for affected programs, whichever is greater.                             |
...
| maximum       | a loan exceeding $150,000 or the single family maximum  mortgage limit for affected programs, whichever is greater.  |
| greater       | maximum mortgage limit for affected programs, whichever is greater .                                                 |
| maximum       | a loan exceeding $150,000 or the single family maximum  mortgage limit for affected programs, whichever is greater.  |
| greater       | maximum mortgage limit for affected programs, whichever is greater .                                                 |
