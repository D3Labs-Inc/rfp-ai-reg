...
| within        | and if no satisfactory settlement has been reached within 5 days after finding that a prima facie                                |
...
| Condition   | Context                                                                                                                |
|:------------|:-----------------------------------------------------------------------------------------------------------------------|
| if          | alleged violations of the policy and the results, if  any, of their invocation.                                        |
