...
| before        | legend containing the number of the official establishment before it leaves the establishment in which it is          |
...
| when        | storage, need not bear the official inspection legend. when                                                         |
