# Title
 ...
 Judicial Administration. PART 83—GOVERNMENT-WIDE REQUIREMENTS FOR DRUG-FREE WORKPLACE (GRANTS)
...
| Entities    | ['Cooperative', 'Debarment', 'Columbia', 'United States', 'Grant', 'Briefly', 'Employee', 'Individual', 'Justice', 'Puerto Rico', 'Categorical', 'Suspension', 'Federal Government'] |
...
| not to exceed | under 28 CFR Part 67, for a period not to exceed  five years.                                    |
...
| Duration   | Context                                                                                                                                                                                                                                |
|:-----------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 day      | (c) Lets each employee know that, as a condition of employment under any award, he or she:                                                                                                                                             |
...
| 5 year     | If a recipient is determined to have violated this part, as described in &#167;&#8201;83.500 or &#167;&#8201;83.505, the Department of Justice may take one or more of the following actions&#8212;                                    |
...
| if          | terms of the statement; and (2) Must not if y you in writing                                                           |
...
| if          | (c) If you ident if ied workplaces to the Department of Justice awarding                                               |
| if          | must I do to comply with this part if  I am an individual recipient?                                                   |
| if          | condition of receiving a(n) Department of Justice award, if you are an individual recipient, you must agree            |
| if          | condition of receiving a(n) Department of Justice award, if you are an individual recipient, you must agree            |
| unless      | designee for each award that you currently have, unless &#167;&#8201;83.301 or the award document designates a central |
| if          | requirements in&#8212; (a) Subpart B of this part, if the recipient is not an individual; or (b)                       |
| if          | requirements in&#8212; (a) Subpart B of this part, if the recipient is not an individual; or (b)                       |
| if          | in violation of the requirements of this part if the Attorney General or designee determines, in writing,              |
| if          | in violation of the requirements of this part if the Attorney General or designee determines, in writing,              |
| if          | award, or suspension or debarment of a recipient if the Attorney General determines that such a waiver                 |
...
| Entities           | Context                                                                                                                                             |
|:-------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------|
| Justice            | of an assistance award from the Department of Justice ; or                                                                                          |
|                    |             (2) A(n) Department of                                                                                                                  |
